...
public class EstudianteBuscarInscripcion extends JPanel{

	JPanel panel;
	InterfazPrincipal main;
	
	public EstudianteBuscarInscripcion(JPanel p, InterfazPrincipal pInterfazPrincipal) {
		...
		bienvenido.setText("Inscripcion buscar");
